...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="max-w-md w-full bg-white shadow-lg rounded-lg p-8 text-center">
        ...
        <h2 class="text-xl font-semibold text-gray-600 mb-4">Forbidden Access</h2>
        <p class="text-gray-500 mb-8">
            Sorry, you don't have permission to access the **Inventory Admin Dashboard**. Please contact your system administrator if you think this is a mistake.
        </p>
